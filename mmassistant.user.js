// ==UserScript==
// @name        MountyHall - Assistant Mélanges Magiques
// @namespace   Violentmonkey Scripts
// @description ~ Affichage % de Stabilisation des compos + Assistant Mélange Magique ~
...
// @include     */MH_Play/Actions/Competences/Play_a_CompetenceYY*
...
if ((isPage('MH_Taniere/TanierePJ_o_Stock') || isPage('MH_Comptoirs/Comptoir_o_Stock')) &&
	window.location.href.indexOf('as_type=Composant') ||
	window.location.href.indexOf('ai_Cat=6050')  != -1) {
...
//	&& window.localStorage[numTroll + '.MM_popos']) {
	try {
		...
		var selectPopo2 = document.getElementById('potion2');
		var selectCompo = document.getElementById('cible');
	} catch(e) {
		window.console.error("[mmassistant] Structure de page inconnue - OFF");
		return;
	}
